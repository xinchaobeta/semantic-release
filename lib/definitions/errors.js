...
- A link to the **semantic-release** plugin developer guide: [${linkify('docs/developer-guide/plugin.md')}](${linkify(
  ...
  EINVALIDBRANCH: ({branch}) => ({message: 'TODO', details: 'TODO'}),
  EINVALIDBRANCHNAME: ({branch}) => ({message: 'TODO', details: 'TODO'}),
  ELTSBRANCH: ({branch}) => ({message: 'ELTSBRANCH ' + branch.name, details: 'TODO'}),
  EPRERELEASEBRANCH: ({branch}) => ({message: 'EPRERELEASEBRANCH ' + branch.name, details: 'TODO'}),
  ELTSBRANCHES: ({branches}) => ({message: 'ELTSBRANCHES', details: 'TODO'}),
  ERELEASEBRANCHES: ({branches}) => ({message: 'ERELEASEBRANCHES', details: 'TODO'}),
  EPRERELEASEBRANCHES: ({branches}) => ({message: 'EPRERELEASEBRANCHES', details: 'TODO'}),
  EDUPLICATEBRANCHES: ({duplicates}) => ({message: 'TODO', details: 'TODO'}),
  EINVALIDNEXTVERSION: ({version, branch}) => ({message: 'TODO', details: 'TODO'}),
  EINVALIDLTSMERGE: ({nextRelease, branch}) => ({message: 'TODO', details: 'TODO'}),
};
